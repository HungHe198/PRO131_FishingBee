...
namespace Data_FishingBee.Migrations
{
    ...
    [Migration("20241107120954_lan28")]
    partial class lan28
    {
            ...
            modelBuilder.Entity("Data_FishingBee.Models.CategoryRevenue", b =>
                {
                    ...
                    b.Property<float>("PercentageRevenueCategory")
                        .HasColumnType("real");

                    b.Property<decimal>("TotalProfitCategory")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("TotalQuantityCategory")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data_FishingBee.Models.ProductRevenue", b =>
                {
                    ...
                    b.Property<float>("PercentageRevenueProduct")
                        .HasColumnType("real");

                    b.Property<Guid>("ProductDetailId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("TotalProfitProduct")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("TotalQuantityProduct")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data_FishingBee.Models.Cart_Product", b =>
                {
                    ...
                    b.HasOne("Data_FishingBee.Models.Product", null)
                        .WithMany("Cart_Products")
            ...
            modelBuilder.Entity("Data_FishingBee.Models.Inventory", b =>
                {
                    b.HasOne("Data_FishingBee.Models.ProductDetail", "ProductDetail")
                        .WithOne("Inventory")
                        .HasForeignKey("Data_FishingBee.Models.Inventory", "ProductDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data_FishingBee.Models.ProductRevenue", b =>
                {
                    b.HasOne("Data_FishingBee.Models.ProductDetail", "ProductDetail")
                        ...
                        .HasForeignKey("Data_FishingBee.Models.ProductRevenue", "ProductDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data_FishingBee.Models.WishList", b =>
                {
                    b.HasOne("Data_FishingBee.Models.ProductDetail", "ProductDetail")
                        .WithOne("WishList")
                        .HasForeignKey("Data_FishingBee.Models.WishList", "ProductDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
